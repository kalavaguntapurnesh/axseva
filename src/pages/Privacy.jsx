                      ...
                      >
                        ...
                        <div className="space-y-2 xl:text-start text-center ">
                          <p>
                            ...
                            related to this Privacy Policy or your personal
                          ...
                          <ul className=" list-disc xl:ml-3 space-y-1">
                            <li>
                              To administer, plan, and manage the relationship
                              with individuals and to communicate with
                              individuals.
                            </li>
                            <li>
                              To better understand how the Company may improve
                              its products and services, to develop and conduct
                              its business and operations, and for other
                              internal business purposes.
                            </li>
                            <li>
                              To provide individuals with information on current
                              and future products and services or other
                              developments with respect to the Company and its
                              affiliates and partners (in accordance with
                              Canada’s Anti-Spam Legislation – see below)
                            </li>
                            <li>
                              To comply with applicable legal and regulatory
                              requirements or to protect the Company’s legal
                              rights and property. To provide individuals with
                              requested information, products, support, and/or
                              services;
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="space-y-2 xl:text-start text-center pt-4">
                          <div className="space-y-2 xl:text-start text-center ">
                            <p>
                              If you have any questions, concerns, or requests
                              related to this Privacy Policy or your personal
                              information, please contact us at info@axseva.com
                            </p>
                            ...
                            <ul className=" list-disc xl:ml-6 space-y-1">
                              ...
                              <li>
                                To better understand how the Company may improve
                                its products and services, to develop and
                                conduct its business and operations, and for
                                other internal business purposes;
                              </li>
                              <li>
                                To provide individuals with information on
                                current and future products and services or
                                other developments with respect to the Company
                                and its affiliates and partners (in accordance
                                with Canada’s Anti-Spam Legislation – see
                                below); and
                              </li>
                              <li>
                                To comply with applicable legal and regulatory
                              ...
                              <li>
                                ...
                                information, products, support, and/or services;
                              </li>
                            </ul>
                          </div>
                        </div>
