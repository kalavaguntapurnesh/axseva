    ...
    const values3 = [
        {
           ...
           description:"Our experts can help to diagnose whether your current system is compatible to manage your current workflow or not. Our Dynamics 365 Support Services are offered to drive your system health check and upgrade your system accordingly to seamlessly carry out all your practices."
        },
        {
            icon: <MdOutlineSettings />,
        ...
        },
        {
            ...
            description:"To drive seamless flow across your operational unit, enterprises should comprise a set of practices, skilled people, and the right working strategies. To gain so, we can help enterprises by configuring their system with required or updated functionality, providing proper training to the end-users, and other support to encourage and bring smoother operational flow."
        },
         {
             icon: <GiAlarmClock />,
             title: "Ensure Compatibility with Trends",
             description:"Considering the continuously changing market, industrial scenarios, and rising critical business challenges, Microsoft ensures regular updates and releases to support your concurrent processes as well as futuristic approach. Through our dedicated support system, we upgrade your system with all the required system capabilities to ensure and drive compatibility with growing market trends."
        },
         {
            icon: <FcCustomerSupport />,
            title: "Custom Support Model",
            description:"Every business involves different processes, different workflow, and strategies. To support your custom processes, your supporting needs could be different. Analyzing and evaluating your specific business flow and the challenges you drive; we can provide customized support services to drive smoother and productive flow across your operational space."
           },
         {
             icon: <FaDatabase />,
             title: "Competitive Pricing",
             description:"TAt Dynamics Square, we believe in providing optimum support services wrapped with standard methodology and a modernized approach to our clients at competitive rates. We offer our Microsoft Dynamics 365 support services at 40% less pricing compared to other Microsoft support services providers. Connect and get the best quote to support your business context."
             },
    ]
                    ...
                    <div className='w-full lg:mx-auto max-w-[1400px] pb-12 px-4 sm:px-6'>
                        <div className='grid md:grid-cols-2 grid-cols-1 lg:gap-4 gap-6'>
                            ...
                            <div className='flex flex-col space-y-6 w-full justify-center'>
                                <div className='lg:text-5xl text-4xl text-center md:text-start font-bold text-sideHeading'>Microsoft Dynamics 365 Support</div>
                                <p className='md:text-lg text-base text-center md:text-start text-sideHeading'>Get seamless and reliable Dynamics 365 support to get your system going even in tough times. Employ your Dynamics 365 solution to its full potential, leveraging the established infrastructure of Dynamics Square, the USA’s leading Microsoft Solutions Partner.</p>
                ...
                <div className='w-full'>
                    <div className='w-full lg:mx-auto max-w-[1400px] pb-12 px-4 sm:px-6'>
                        <div className='flex  w-full justify-center mb-20'>
                            <div className='lg:text-5xl text-4xl text-center md:text-start font-bold text-sideHeading'>Dedicated Dynamics 365 Support Partner</div>
                        </div>
                        <div className='grid md:grid-cols-2 grid-cols-1 lg:gap-4 gap-6'>
                            {/* grid 1 */}
                            <div className='flex justify-center items-center w-full'>
        ...
        <div className="mt-5">
            <div className="relative">
                ...
                <div className="w-full lg:mx-auto max-w-[1400px] pb-12 px-4 sm:px-6 mx-auto">
                    ...
                    Drive innovative and strategic approach through your business premises with intelligent connected processes, data insights, and adaptive <span className='text-mainColor cursor-pointer'>Dynamics 365 CRM</span> & <span className='text-mainColor cursor-pointer'>ERP solutions.</span>
                    </p>
                    ...
                    <div className="max-w-[1200px] md:mx-auto grid md:grid-cols-2 grid-cols-1 md:gap-6 gap-10 flex justify-center py-[100px]">
                        ...
                        <div className='flex flex-col space-y-10 w-full justify-center'>
                            <div className='lg:text-5xl text-4xl text-center md:text-start font-bold text-sideHeading'>Dynamics 365 Support Plans We Offer</div>
                            <p className='md:text-lg text-base text-center md:text-start text-sideHeading'>Dynamics Square, your trusted <span className='text-mainColor cursor-pointer'>Microsoft Dynamics partner</span> will handle every aspect of your Dynamics 365 system from user support, training, customization, technical consultancy to development work.</p>      
                        </div>
            ...
            <div className="relative">
                ...
                <div className="w-full lg:mx-auto max-w-[1400px] pb-12 px-4 sm:px-6 mx-auto">
                    ...
                    <p className="text-base text-white text-center md:text-lg">
                        Discuss your Dynamics 365 support requirements to get the best advice from our Microsoft consultant.
                    </p>
                    {/* CTA Button */}
                ...
                {values1.map((value, index) => (
                  ...
                  >
                    ...
                    <div className="p-4 text-4xl rounded-full">
                     <span className='text-mainColor text-5xl'>{value.icon}</span> 
                    </div>
